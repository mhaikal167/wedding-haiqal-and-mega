...
export function HeroSection({ onScrollToMessages, onShare }: HeroSectionProps) {
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(135deg, #fefcf8 0%, #fdf9f3 25%, #fcf7ee 50%, #fbf5e9 75%, #faf3e4 100%)",
      }}
    >
      ...
      <div className="relative z-10 text-center px-4 max-w-md mx-auto">
        <p className="text-amber-700 text-lg font-medium mb-4 tracking-wide">
          ...
          <div className="absolute -top-4 -left-8 z-20">
            ...
            >
              <g transform="translate(10,10)">
                <path
                  d="M30 20 Q35 15 40 20 Q35 25 30 20"
                  fill="currentColor"
                  opacity="0.8"
                />
                <path
                ...
                />
                <path
                  d="M35 30 Q40 25 45 30 Q40 35 35 30"
                  fill="currentColor"
                  opacity="0.6"
                />
          ...
          <div className="absolute -bottom-6 -right-6 z-20">
            ...
            >
              <g transform="translate(20,20)">
                <path
                  d="M20 30 Q25 25 30 30 Q25 35 20 30"
                  fill="currentColor"
                  opacity="0.8"
                />
                <path
                  d="M30 35 Q35 30 40 35 Q35 40 30 35"
                  fill="currentColor"
                  opacity="0.7"
                />
                <path
                  d="M40 25 Q45 20 50 25 Q45 30 40 25"
                  fill="currentColor"
                  opacity="0.6"
                />
                <path
